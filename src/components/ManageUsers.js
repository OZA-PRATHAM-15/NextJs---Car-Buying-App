    ...
    return (
        <div style={{ padding: '20px', color: 'white' }}>
            ...
            >
                ...
                >
                    <h3>Male Users</h3>
                    <p style={{ fontSize: '24px', fontWeight: 'bold' }}>{genderCounts.Male}</p>
                </div>
                <div
                    style={{
                        background: 'linear-gradient(to right, #2a2a2a, #1e1e1e)',
                ...
                >
                    <h3>Female Users</h3>
                    <p style={{ fontSize: '24px', fontWeight: 'bold' }}>{genderCounts.Female}</p>
                </div>
                <div
                    style={{
                        background: 'linear-gradient(to right, #2a2a2a, #1e1e1e)',
                ...
                >
                    <h3>Other Users</h3>
                    <p style={{ fontSize: '24px', fontWeight: 'bold' }}>{genderCounts.Other}</p>
                </div>
            </div>
            <div
                style={{
