...
const SidebarFilter = ({ filters, setFilters, resetFilters }) => {
    ...
    const applyFilters = () => {
        setFilters(tempFilters); // Call the function passed from the parent
    };
    const handleReset = () => {
        setTempFilters({
            search: '',
        ...
        resetFilters(); // Call the resetFilters function from parent
    };
    ...
    return (
        <div style={sidebarStyle}>
            ...
            <div style={filterGroup}>
                ...
                <select
                    name="fuel"  // Change this to 'fuel_type'
                    value={tempFilters.fuel_type} // Update state to reflect the new field name
                    onChange={handleFilterChange}
                    style={filterInput}
                >
