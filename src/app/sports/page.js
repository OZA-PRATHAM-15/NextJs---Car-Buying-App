...
const SedanPage = () => {
    ...
    const fetchCars = async (appliedFilters = filters) => {
        try {
            ...
            const res = await fetch(`http://localhost:5000/api/cars/type/sports?${queryParams}`);
    ...
    return (
        <div style={containerStyle}>
            ...
            <div style={heroSectionStyle}>
                ...
                <h1 style={heroTitleStyle}>Sports</h1>
                <p style={heroSubtitleStyle}>Explore our premium collection of sports car</p>
            </div>
