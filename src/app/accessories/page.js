...
const SedanPage = () => {
    ...
    const fetchCars = async (appliedFilters = filters) => {
        try {
            ...
            const res = await fetch(`http://localhost:5000/api/cars/type/accessory?${queryParams}`);
    ...
    return (
        <div style={containerStyle}>
            ...
            <div style={heroSectionStyle}>
                ...
                <h1 style={heroTitleStyle}>Accessories</h1>
                <p style={heroSubtitleStyle}>Explore our premium collection of our accessories</p>
            </div>
